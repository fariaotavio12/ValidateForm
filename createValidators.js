function createValidators(form, validacoes, errorMessages) {
	var context = this;
...
function required(form, field, params, errorMessages, fieldName) {
...
function string(form, field, params, errorMessages, fieldName) {
	var value = form.getValue(field);
...
function requiredOn(form, field, params, errorMessages, fieldName) {
...
function integerOnly(form, field, params, errorMessages, fieldName) {
	var value = form.getValue(field);
...
function floatOnly(form, field, params, errorMessages, fieldName) {
	var value = form.getValue(field);
	var regex = /^[0-9]*\.?[0-9]+$/;
...
function date(form, field, params, errorMessages, fieldName) {
	var value = form.getValue(field);
